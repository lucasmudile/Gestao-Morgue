        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block " name="logar" value="Entrar">
                                    



                                            <?php
                # INCLUINDO O MODEL DO USUARIO
                include_once('model/usuario.php');

                # INCLUINDO O CONTROLLER DO USUARIO
                ...
                if(isset($_POST['logar'])) {
                    ...
                    $utilizador->setSenha(md5($_POST['senha']));

                    $login = new CrudUsuario();
