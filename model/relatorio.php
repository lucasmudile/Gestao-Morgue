...
//relatorio
public function getRelAnual(){
		return $this->relAnual;
	}

	public function setRelAnual($relAnual){
		$this->relAnual=$relAnual;
	}
	public function getRelMensal(){
		return $this->relMensal;
	}

	public function setRelMensal($relMensal){
		$this->relMensal=$relMensal;
	}
	public function getRelData(){
		return $this->relData;
	}

	public function setRelData($relData){
