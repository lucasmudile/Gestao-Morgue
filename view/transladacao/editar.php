<?php
    ...
    if($id != null) {
        ...
        $selectFuncionario = new CrudTransladacao();
                            ...
                            <form class="user" id="" method="POST">
                              ...
                              <hr>
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" value="<?php echo $funcionario->getId(); ?>" name="id_">
                                     ...
                                     <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="destino" name="destino" placeholder="Destino" value="<?php echo $funcionario->getDestino(); ?>"  >
                                    </div>

                                </div>

                                <input type="submit" class="btn btn-primary btn-user btn-md" name="salvar" id="salvar" value="Editar" >
