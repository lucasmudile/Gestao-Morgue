<?php
    ...
    if($id != null) {
        ...
        $selectFuncao = new CrudProveniencia();
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="">
                                <h1 class="h4 text-gray-900 mb-4">Editar Proveniencia</h1>
                            </div>
                                    ...
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                      <label class="text-gray-900">Proveniência</label>
                                        <input type="text" class="form-control form-control-user" id="nome_"
                                            placeholder="Nome Completo" name="nome_" value="<?php echo $funcao->getLocal(); ?>" >
