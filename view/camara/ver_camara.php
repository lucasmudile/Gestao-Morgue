                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Nº de Gaveta</th>
                                    <th scope="col">Gavetas Ocupadas</th>
                                ...
                                <?php
                                                ...
                                                foreach ($dados as $key => $value) {
                                                   echo '<tr>
                                                            ...
                                                            <td>'.$value->getReferencia().'</td>
                                                            <td>'.$value->getN_GavetaTotal().'</td>
                                                             <td>'.$value->getN_GavetaOcupada().'</td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">'.$value->getReferencia().'</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">Tens certeza que deseja eliminar esta camara ?</div>
