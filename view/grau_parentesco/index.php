            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="">
                                <h1 class="h4 text-gray-900 mb-4">Cadastrar Grau Parentesco</h1>
                            </div>
                            ...
                            <?php   
                                 ...
                                 include('../../model/grau_parentesco.php');
                                 include('../../controller/crud-grau_parentesco.php');
                                      $funcao=new GrauParentesco();
                                      if (isset($_POST['guardar'])) {
                                          $funcao->setDescricao($_POST['nome_']);
                                          $insert = new CrudGrauParentesco();
